...
public class RechargeRecordServiceImpl extends BaseServiceImpl<RechargeRecord, Long, RechargeRecordMapper> implements RechargeRecordService {
    ...
    @Override
    public void saveRecord(Long operatorId, Long demanderId, RechargeRecordDef.RechargeRecordTypeEnum type, BigDecimal oldBalance, BigDecimal newBalance) {
        ...
        rechargeRecord.setType(type.getCode());
